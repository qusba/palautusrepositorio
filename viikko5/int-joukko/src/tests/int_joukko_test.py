...
from int_joukko import JoukkoOperaatiot
...
class TestIntJoukko(unittest.TestCase):
    ...
    def test_yhdiste(self):
        ...
        operaatio_olio = JoukkoOperaatiot(eka,toka)
        tulos = operaatio_olio.yhdiste()
